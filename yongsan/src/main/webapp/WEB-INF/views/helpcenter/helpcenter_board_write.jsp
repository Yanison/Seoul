...
<div class="wrapperDiv">
	...
	<main class="main">
		...
		<form method="get" action="/helpcenter/board/write">
		<div class="boardWrite">
			...
			<div id="boardWrite_header" class="boardWrite_header">
				...
				<input id="boardTitle" class="app-inp boardInput boardTitle" type="text" name="bdTitle"placeholder="제목">
				<textarea id="boardContents" class="boardInput boardContents" id="bdContent" name="bdContent"></textarea>
