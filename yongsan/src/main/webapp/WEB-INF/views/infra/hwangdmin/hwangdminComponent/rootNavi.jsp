		...
		<div class="accordion-item">
		    ...
		    <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOne">
		      <div class="accordion-body">
		      		<a id="nvai-user-info" class="accordion-body-menue" >거래소 정보</a>
		      		<a class="accordion-body-menue">거래소 자산 조회</a>
		      		<a class="accordion-body-menue" href="http://127.0.0.1:8082/cryptogroup/cryptoGroupList">거래소 코인 관리</a>			      
		      </div>
		    </div>
		  </div>
	</div>
