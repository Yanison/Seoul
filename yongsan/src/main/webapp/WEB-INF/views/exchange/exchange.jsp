		...
		<div class="ex_main">
			...
			<section class="trading">
				<article class="exnotice">
					<div class="exnoticeL">
						<span style="display: block"><i
							class="fa-solid fa-exclamation"></i> <strong>공지</strong></span>
					</div>
					<div class="exnoticeR">
				...
				<div class="chartBox boxes">
					...
					<div class="chartBoxHeader">
						<div class="_chartBoxHeader">
							<div class="chartBoxHeaderLeft">
								<div class="dropdown">
									<button class="btn btn-secondary" type="button"
										...
										style="background: none; border: none; color: #666666">
										<img class="btcLogo"
											src="https://static.upbit.com/logos/BTC.png"
											alt="https://static.upbit.com/logos/BTC.png"> <strong
											style="font-size: 20px; color: #333333; padding: 5 5 5 0px;">비트코인</strong>
							...
							<div class="chartBoxHeaderRight">
								<a class="cryptoPrice chartBoxHeaderContents"> 시세 </a> <a
									class="cryptoInfo chartBoxHeaderContents"> 정보 </a>
							</div>
						</div>
						<div class="dropdown-center" style="padding-top: 5px;">
							<button class="btn btn-secondary" type="button"
								data-bs-toggle="dropdown"
								style="margin-top: 2px; width: 30px; height: 30px; padding: 5px 8px;">
								<i class="fa-solid fa-gear" style="color: #999999;"></i>
							</button>
							<ul class="dropdown-menu setting"
								style="transform: translate3d(-234.5px, 42px, 0px);">
								...
								<li class="settingContents">
									<div class="darkMod">
										<div class="darkModBtn">
											<span class="darkModBtn1"
												style="border-right: 1px solid #dedede;"><i
												class="fa-solid fa-sun"></i></span> <span class="darkModBtn2"><i
								...
								<li class="settingContents">
									<div class="form-check bidpriceChkBox">
										<input class="form-check-input" type="checkbox" value=""
											...
											style="padding-top: 1px;"> 일반 호가에 평균가/누적량/누적액 노출 </label>
									</div>
								</li>
								...
								<li class="settingContents chartSettingHigh">
									<div class="darkMod">
										<div class="darkModBtn">
											<span class="darkModBtn1"
												style="border-right: 1px solid #dedede;"><i
												class="fa-solid fa-plus" style=""></i></span> <span
												class="darkModBtn2"><i class="fa-solid fa-minus"></i></span>
										</div>
										<div class="darkModText">
											<div style="font-size: 13px; color: #666666;">차트 높이 설정</div>
											<div style="font-size: 12px; color: #c84a31;">가장 작은 높이의
												차트입니다.</div>
										</div>
									</div>
								</li>
								<li class="settingContents">
									<div class="form-check bidpriceChkBox"
										...
										<input class="form-check-input" type="checkbox" value=""
											id="flexCheckIndeterminate"> <label
											class="form-check-label" for="flexCheckIndeterminate"
											style="padding-top: 1px;"> 차트에 매수평균가 기준선 노출 </label>
									</div>
								</li>
								<li class="settingContents">
									<p style="font-size: 12px; color: #666666; margin-top: 18px;">
										차트설정 옵션은 회원님의 투자 편의를 제공하는 것으로, 업비트는 제공된 정보에 의한 투자 결과에 대해 책임을
										지지 않습니다.</p>
								</li>
							</ul>
						</div>
					...
					<div class="livePriceBox">
						...
						<div class="otherMarket">
							<span class="otherMarketContents"> <span
								class="marketName">Bitfinex</span> <span class="MPrice">29,893,044</span>
								<span class="MPriceUSD">($22,861.00)</span>
							</span> <span class="otherMarketContents"> <span
								class="marketName">Kraken</span> <span class="MPrice">29,936,325</span>
								<span class="MPriceUSD">($22,894.00)</span>
							</span> <span class="otherMarketContents"> <span
								class="marketName">Liquid</span> <span class="MPrice">29,958,307</span>
							...
							<div class="liveChartboxMenu">
								<div class="lCLeftMenu">
									<span class="menuContents"> 
										<iclass="fa-solid fa-window-maximize"></i>
									</span>
								</div>
								<div class="lCRightMenu"></div>
							</div>
						</div>
					</div>
				...
				<div class="tradingBox">
					<div class="bidPriceBox boxes">
						<div class="bidPriceBoxNav nav">
							<div class="tabList">
								<a id="orderContainerPrice" class="nav-link navItem"
									aria-current="page" href="#1">일반호가</a> <a
									id="orderContainerOrderPrice" class="nav-link navItem"
									href="#2">누적호가</a> <a id="orderContainerOrderNavigation"
									class="nav-link navItem" href="#3">호가주문</a> <a class="myBorder">|</span>
							</div>
							<div>
								<div class="dropdown">
									<button class="btn btn-secondary dropdown-toggle" type="button"
										data-bs-toggle="dropdown" aria-expanded="false"
										style="color: #333333; width: 80px; height: 30px; margin-top: 3px">
										모아보기
										<!--  모아보기는 옵션 단위로 축약해서 호가창을 볼 수 있는 기능임 -->
									</button>
									<ul class="dropdown-menu"
										style="transform: translate3d(-60px, 35px, 0px)">
							...
							<div class="orderContainerTotal">
								<table class="total">
									...
									<tr>
										...
										<td class="amountToggle"><a id="amountToggle01"> <b>수량</b>
												<em>(BTC)<em> <i class="fa-solid fa-right-left"
														style="margin-left: 5px; color: #333;"></i></a></td>
						...
						<div id="orderContaineritem2_1">
							<div class="orderContainerTotal">
								<table class="total">
									...
									<tr>
										<td></td>
										<td class="amount"><b>수량</b> <em>(BTC)<em></td>
										<td class="orderPrice"><b>금액</b> <em>(KRW)<em></td>
										<td class="total"><b>누적금액</b> <em>(KRW)<em></td>
										<td class="last"></td>
									</tr>
								</table>
							</div>
							...
							<div class="orderContainerTotal">
								<table class="total">
									...
									<tr>
										<td></td>
										<td class="lAlign">soldamount</td>
										<td class="amountToggle"><a id="amountToggle02"> <b>수량</b>
												<em>(BTC)<em> <i class="fa-solid fa-right-left"
														style="margin-left: 5px; color: #333;"></i></a></td>
										<td class="rAlign">boughtamount</td>
										<td class="last"></td>
				...
				<div class="trasactedHistoryDiv">
					<%@ include file="transacationHistory/transacationHistory.jsp"%>
				</div>
			</section>
			<div class="cryptoListDiv">
				<%@ include file="cryptoList/cryptoList.jsp"%>
			</div>
