							...
							<div class="chartBoxHeaderLeft">
								<div class="dropdown">
								  <button class="btn btn-secondary" type="button" data-bs-toggle="dropdown" style="background:none; border:none; color: #666666">
								    <img class="cryptoLogo" src="../resources/image/cryptoLogo/EZCLogo.png" alt="https://static.upbit.com/logos/BTC.png" >			    
								    <strong class="cryptoName"  style="font-size:20px; color:#333333; padding:5 5 5 0px;">이젠코인</strong>
					...
					<div class="bidPriceBox boxes">
						...
						<div id= "orderContainer" class="orderContainer">
								...
								<div id="orderContaineritem1">
										...
										<%@include file="/WEB-INF/views/exchange/orderContainer/orderContainerPrice.jsp" %>
